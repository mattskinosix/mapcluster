...
public class ArraySet {
	private boolean set[];
	private int size=0;
	//costruttore che inizializza l'array al valore booleano falso di 50 elementi
	public ArraySet (){
		set=new boolean[50];
	...
	public boolean add(int i){
		if(i>=set.length)
		{
			...
			Arrays.fill(temp,false); //temp vettore al doppio di set tutto iniziallizzato a falso
